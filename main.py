...
@app.get("/PlayTimeGenre/{genero}", response_model=Dict[str, int], description="Devuelve el año con más horas jugadas para un género dado.")
async def playtime_genre(genero: str = Query(..., description="Género de juego")):
...
@app.get("/UserForGenre/{genero}", response_model=Dict[str, List[Dict[str, int]]], description="Devuelve el usuario con más horas jugadas para un género dado y las horas jugadas por año.")
async def user_for_genre(genero: str = Query(..., description="Género de juego")):
...
@app.get("/UsersRecommend/{year}", response_model=List[Dict[str, str]], description="Devuelve los 3 juegos más recomendados para un año dado.")
async def users_recommend(year: int = Query(..., description="Año de lanzamiento")):
...
@app.get("/UsersWorstDeveloper/{year}", response_model=List[Dict[str, str]], description="Devuelve los 3 desarrolladores con más juegos no recomendados para un año dado.")
async def users_worst_developer(year: int = Query(..., description="Año de lanzamiento")):
...
@app.get("/sentiment_analysis/{empresa_desarrolladora}", response_model=Dict[str, List[str]], description="Devuelve el análisis de sentimientos para los juegos de una empresa desarrolladora.")
async def sentiment_analysis(empresa_desarrolladora: str = Query(..., description="Empresa desarrolladora")):
